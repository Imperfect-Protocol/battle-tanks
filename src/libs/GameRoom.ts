...
import type { BoardRecord, CommandTimelineRecord, OrderRecord, PlayerCommandRecord, PlayerRecord, ProjectileRecord, TankRecord, WorldEventRecord } from "./types";
...
export class GameRoom {
  ...
  constructor(
    ...
    readonly commandTimelines: CommandTimelineRecord[] = [],
